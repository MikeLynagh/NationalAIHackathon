...
class AIEngine:
    ...
    def generate_appliance_insights_ai(self, usage_df: pd.DataFrame, 
                                     detected_appliances: List[Dict]) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            appliance_summary = self._prepare_appliance_summary(usage_df, detected_appliances)
    ...
    def optimize_recommendations_ai(self, usage_df: pd.DataFrame, 
                                  current_recommendations: List[Dict]) -> List[Dict]:
        """
        ...
        try:
            ...
            rec_summary = self._prepare_recommendation_summary(usage_df, current_recommendations)
    ...
    def _call_ai_api(self, prompt: str) -> str:
        ...
        try:
            ...
            if elapsed > self.timeout:
                logger.warning(f"AI API call took {elapsed:.2f}s (exceeded {self.timeout}s timeout)")
    ...
    def _calculate_hourly_patterns(self, usage_df: pd.DataFrame) -> Dict[str, List[float]]:
        ...
        return {
            'import_by_hour': hourly_import,
            'export_by_hour': hourly_export
        }
    ...
    def _fallback_appliance_insights(self, detected_appliances: List[Dict]) -> Dict[str, Any]:
    ...
    def _prepare_appliance_summary(self, usage_df: pd.DataFrame, 
                                 detected_appliances: List[Dict]) -> Dict[str, Any]:
    ...
    def _prepare_recommendation_summary(self, usage_df: pd.DataFrame, 
...
def generate_appliance_insights_ai(usage_df: pd.DataFrame, 
                                 detected_appliances: List[Dict]) -> Dict[str, Any]:
...
def optimize_recommendations_ai(usage_df: pd.DataFrame, 
                              current_recommendations: List[Dict]) -> List[Dict]:
    """Optimize recommendations using AI."""
    engine = AIEngine()
